...
function preload(){
  ...
  hp3img = loadImage("hp3.png");
  hp4img = loadImage("hp4.png");
  ...
  riddle2img = loadImage("spell2.png");
...
function setup(){
  createCanvas (1000,1800);
   ...
   hp2 = createSprite(300,1600,20,20);
   hp2.addImage(hp2img);
   hp2.scale= 0.3
   ...
   cave2 = createSprite(300, 1400, 20, 20);
   ...
   centaur2 = createSprite(300, 1200, 20, 20);
   ...
   forest2 = createSprite(300, 1000, 20, 20);
  ...
  wizard2 = createSprite(300, 800, 20, 20);
  ...
  dem2 = createSprite(300, 600, 20, 20);
  ...
  river2 = createSprite(300, 400, 20, 20);
  ...
  centaur6 = createSprite(300, 200, 20, 20);
...
function spawnCentaur() {
  if(hp1.isTouching(centaur1)){
    hp1.velocityY = 0;
    centaur1.destroy();
   riddle2 = createSprite(200,2000,20,20);
   riddle2.addImage(riddle2img);
   riddle2.scale= 0.9;
    
   riddle2Answer = createSprite(300, 1250, 10, 10);
   riddle2Answer.addImage(riddle2Ansimg);
   riddle2Answer.scale = 0.5;
    
  riddle2Option = createSprite();
  riddle2Option.addImage(riddle2Optimg);
  riddle2Option.scale = 0.5;
  }
}
...
function spawnForest() {
   ...
   forestRiddle.scale= 0.7;
     
   riddle3Answer = createSprite();
   riddle3Answer.addImage(riddle3Ansimg);
   riddle3Answer.scale = 0.5;
     
  riddle3Option = createSprite();
  riddle3Option.addImage(riddle3Optimg);
  riddle3Option.scale = 0.5;
  }
}
...
function spawnWizard() {
   if(hp1.isTouching(wizard1)){
    hp1.velocityY = 0;
    wizard1.destroy();
   wizardRiddle = createSprite(200,900,20,20);
   wizardRiddle.addImage(wizardRidimg);
   wizardRiddle.scale= 0.7;
     
   riddle4Answer = createSprite();
   riddle4Answer.addImage(riddle4Ansimg);
   riddle4Answer.scale = 0.5;
     
   riddle4Option = createSprite();
   riddle4Option.addImage(riddle4Ansimg);
   riddle4Option.scale = 0.5;
  }
}
...
function spawnDem() {
   if(hp1.isTouching(dem1)){
    hp1.velocityY = 0;
    dem1.destroy();
   demRiddle = createSprite(200,900,20,20);
   demRiddle.addImage(demRidimg);
   demRiddle.scale= 0.7;
     
   riddle5Answer = createSprite();
   riddle5Answer.addImage(riddle5Ansimg);
   riddle5Answer.scale = 0.5;
    
   riddle5Option = createSprite();
   riddle5Option.addImage();
   riddle5Option.scale = 0.5;
  }
}
...
function spawnCav() {
  ...
  if(hp2.isTouching(cave2)){
   ...
   riddle8Answer = createSprite();
   riddle8Answer.addImage(riddle1Ansimg);
   riddle8Answer.scale = 0.5;
    
  riddle8Option = createSprite();
  riddle8Option.addImage(riddle1Optimg);
  riddle8Option.scale = 0.5;
  }
}
...
function spawnCen() {
  if(hp2.isTouching(centaur2)){
    hp2.velocityY = 0;
    centaur2.destroy();
   spell2 = createSprite(200,1350,20,20);
   spell2.addImage(spell2img);
   spell2.scale= 0.7;
    
   riddle9Answer = createSprite();
   riddle9Answer.addImage(riddle2Ansimg);
   riddle9Answer.scale = 0.5;
    
  riddle9Option = createSprite();
  riddle9Option.addImage(riddle2Optimg);
  riddle9Option.scale = 0.5;
  }
}
...
function spawnFor() {
   ...
   riddle10Answer = createSprite();
   riddle10Answer.addImage(riddle3Ansimg);
   riddle10Answer.scale = 0.5;
     
  riddle10Option = createSprite();
  riddle10Option.addImage(riddle3Optimg);
  riddle10Option.scale = 0.5;
  }
}
...
function spawnWiz() {
   ...
   riddle11Answer = createSprite();
   riddle11Answer.addImage(riddle4Ansimg);
   riddle11Answer.scale = 0.5;
     
  riddle11Option = createSprite();
  riddle11Option.addImage(riddle4Optimg);
  riddle11Option.scale = 0.5;
  }
}
